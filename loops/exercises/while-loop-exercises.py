...
if shuttle_altitude >= 2000:
    final_note = "Orbit achieved!"
else:
    final_note = "Failed to reach orbit."

print("The shuttle gained an altitude of", shuttle_altitude, "km and has", fuel_level, "kg of fuel left.", final_note)