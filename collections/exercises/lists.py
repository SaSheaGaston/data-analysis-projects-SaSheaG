...
other_list = [False, -4.6, '87']
print(adding_practice + other_list)
...
final_list_info = "The list {0} contains {1} items."
print(final_list_info.format(cargo_hold, len(cargo_hold)))